...
<body class="sb-nav-fixed" style="background: #FFE9C9;">
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      ...
      String SQL_QUERY = "SELECT * FROM rezervasyon ";
      ...
      rs = statementProduct.executeQuery(SQL_QUERY);
       while(rs.next()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger" href="rezervasyonsil.jsp?id=<%=rs.getString(1)%>&odaid=<%=rs.getString(2)%>&page=1" >Sil</a>
                                        </td>
                                    </tr>
