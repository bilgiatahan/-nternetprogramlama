<%-- 
    Document   : manzaraekleme
    Created on : Jan 6, 2022, 5:52:04 PM
    Author     : bilgiatahan
--%>
    ...
    <div id="layoutSidenav_content">
        <main style="margin:10px; padding: 7px">
            ...
            <div class="container-fluid" >
                ...
                <form action="manzaraekleme" method="POST">
                    <input type="hidden" value="manzaraekleme" name="oda"/>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label >Manzara Adı</label>
                            <input type="text" autocomplete="off" class="form-control" id="name" name="ManzaraAdi" placeholder="orn. Dağ, Deniz" required>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <label >Manzara Açıklama</label>
                        <textarea cols="55" rows="10" class="form-control text-area" name="ManzaraAciklama">
        
                        </textarea>
                    </div>
                    <br>

                    <button type="submit" class="btn bb">Manzara Kaydet</button>
                </form>
