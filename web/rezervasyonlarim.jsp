<%-- 
    Document   : rezervasyonlarim
    Created on : Jan 6, 2022, 1:02:49 PM
    Author     : bilgiatahan
--%>
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      ...
      String SQL_QUERY = "SELECT * FROM rezervasyon where userId="+(String) session.getAttribute("UserId");
      ...
      rs = statementProduct.executeQuery(SQL_QUERY);
       while(rs.next()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger" href="rezervasyonsil.jsp?id=<%=rs.getString(1)%>&odaid=<%=rs.getString(2)%>" >Sil</a>
                                        </td>
                                    </tr>
