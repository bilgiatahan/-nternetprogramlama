                        ...
                        <div class="card p-3 mb-2">
                            <div class="">
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <div class=" c-details">
                                        <h6 class="mb-0" style="font-size:18px;"><%=rs.getString(2)%> </h6> <span></span>
                                    </div>
                                </div>
                                <div style="padding: 10px 0" > <span style="color:#000; background-color: white;font-weight: bold; font-size: 25px"> <%=rs.getString(7)%> ₺</span> </div>
                            ...
                            <div class="">
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-3"> 
                                        <span class="text1">Manzara : <%=rs.getString(4)%> 
                                            <br>
                                        ...
                                        if(rs.getString(5).equals("1")) {
                                            ...
                                            <a class="btn btn-my" href="odarezervasyon.jsp?odaid=<%=rs.getString(1)%>" >Rezervasyon Yap</a>
